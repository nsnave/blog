const POSTS = [{'title': 'My First Post', 'date': '2022-06-09', 'meta': ['recent'], 'tags': ['Misc.'], 'images': ['./media/memes/p-np-folders.png'], 'caption': "This is my first post! I will be posting more stuff about whatever I feel like -- i.e, mostly stuff relating to computer science, mathematics, and logic. To get started with a light post, here's a handful of TCS/math/logic memes.", 'number': '0'}, {'title': 'Logical Duality and "Et Cetera"', 'date': '2022-12-23', 'meta': ['selected', 'top', 'recent'], 'tags': ['Misc.', 'Logic'], 'images': [''], 'caption': 'In the study of logic, many operators have a <i>dual</i>: AND gates have OR gates, universal quantifiers have existential quantifiers, and so on. We commonly use the term "etc." to abbreviate the Latin phrase "et cetera", which in English roughly translates to "and the like". We don\'t, however, have an abbreviation for "or the like" --- the dual to "etc.". Should we?', 'number': '1'}];
