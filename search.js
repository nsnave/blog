const POSTS = [{'title': 'My First Post', 'date': '2022-06-09', 'meta': ['selected', 'top', 'recent'], 'tags': ['Misc.'], 'images': ['./media/memes/p-np-folders.webp'], 'caption': "This is my first post! I will be posting more stuff about whatever I feel like -- i.e, mostly stuff relating to computer science, mathematics, and logic. To get started with a light post, here's a handful of TCS/math/logic memes.", 'number': '0'}];
